...
from primary.bots.contest.contest_bot import ContestBot
...
from configs.config import MASHI_BOT_TOKEN, HTTP_PORT, CONTEST_BOT_TOKEN
...
async def startup():
    ...
    asyncio.create_task(contest_bot.start(CONTEST_BOT_TOKEN))
